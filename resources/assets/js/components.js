...
pixelfed.readmore = () => {
  $('.read-more').each(function(k,v) {
      ...
      el.readmore({
        collapsedHeight: 45,
        heightMargin: 48,
        moreLink: '<a href="#" class="d-block small font-weight-bold kalanto-text text-center">Show more</a>',
        lessLink: '<a href="#" class="d-block small font-weight-bold kalanto-text text-center">Show less</a>',
      });
  });
};
